// Package demo_v95_multiparty_real provides a mock write connector for v9.5 demos.
//
// CRITICAL: This mock connector does NOT move real money.
// It exists to demonstrate the v9.5 multi-party execution pipeline when TrueLayer is not configured.
